...
if(isset($_GET["buy"])){
    $courseName = $_GET["buy"];
    $query = "SELECT * FROM courses WHERE name_c = '$courseName' ";
    $result = $db->query($query);
    $result->execute();
    $data = $result->fetch(PDO::FETCH_OBJ);
    $_SESSION["nameCourse"] = $data->name_c;
    $_SESSION["priceCourse"] = $data->price;
...
<title>صفحه خرید</title>
  ...
  <body class="container mx-auto flex flex-col bg-gray-900">
    <h1 class="mx-auto text-2xl font-bold text-gray-50 mt-10">صفحه خرید</h1>
    <br />

    <section>
      <form
        class="max-w-3xl mx-auto"
        action="../source/getBuy.php"
        method="post"
      >
          ...
          >
            ...
            >
              <tr>
                ...
                <th scope="col" class="px-6 py-3"><?=$data->price ?> تومان</th>
              </tr>
            </thead>
          </table>
        </div>
